...
public class ExceptionHandlerController {
	...
	public ResponseEntity<Object> handleCustomException(final CustomException ex) {
		...
		return new ResponseEntity<>(getMap(HttpStatus.BAD_REQUEST, ex.getMessage()), new HttpHeaders(),
	...
	public ResponseEntity<Object> handleConstraintViolationException(final ConstraintViolationException ex) {
		...
		return new ResponseEntity<>(getMap(HttpStatus.BAD_REQUEST, errorMsg), new HttpHeaders(),
				HttpStatus.BAD_REQUEST);
	}
	

	private Object getMap(HttpStatus status, String errorMsg) {
